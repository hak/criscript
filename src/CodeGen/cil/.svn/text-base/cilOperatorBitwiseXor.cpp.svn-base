 ...
 * Library  : CRIScript
 * Module   : Add Operator
 * File     : cilOperatorbitwiseXor.cpp
 * Date     : 
 * Version  : 
 *
 ****************************************************************************/
 ...
 ***************************************************************************/	
CCgNodeData* CCilCodeGen::bitwiseXorOperator( CCgNodeData* lhs, CCgNodeData* rhs )
{
	assert( lhs != NULL );
	...
	if( lhs->NodeType == CG_NODE_INTEGERLITERAL || lhs->NodeType == CG_NODE_FLOATLITERAL )
	{
		...
		Node = makeFormulaNode( CG_BITWISEXOR, rhs, lhs );
	}
	else
		Node = makeFormulaNode( CG_BITWISEXOR, lhs, rhs );

	return Node;
};

/***************************************************************************
 * emit bitwiseXor Operation
  ***************************************************************************/	
CCgNodeData* CCilCodeGen::emitBitwiseXorOperator( CCgNodeData* nodetree )
{
