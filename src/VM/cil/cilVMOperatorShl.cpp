...
void CCilVm::ShlOperator()
{
	...
	case OPERAND_INT:
		...
		{
		case OPERAND_INT:
			iValue = shiftTarget.iValue << shiftCount.iValue;
			popEvalStack();
			popEvalStack();
			pushEvalStack( iValue );
			break;
		case OPERAND_INT64:
			i64Value = shiftTarget.i64Value << shiftCount.iValue;
			popEvalStack();
			popEvalStack();
			pushEvalStack( i64Value );
			break;
		default:
			iValue = shiftTarget.toInt() << shiftCount.iValue;
			popEvalStack();
			popEvalStack();
			pushEvalStack( iValue );
			break;
		...
		break;
	default:
		iValue = shiftTarget.toInt() << shiftCount.toInt();
		popEvalStack();
		popEvalStack();
		pushEvalStack( iValue );
		break;
