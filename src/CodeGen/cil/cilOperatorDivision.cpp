 ...
 *
 * Library  : CRIScript
 * Module   : Division Operator
 * File     : cilOperatorDivision.cpp
 * Date     : 
 * Version  : 
 *
 ****************************************************************************/
 ...
 * Division Operation
 ***************************************************************************/	
CCgNodeData* CCilCodeGen::divisionOperator( CCgNodeData* lhs, CCgNodeData* rhs )
{
	assert( lhs != NULL );
	if( rhs == NULL ) return lhs;	//fast pass
	//rhs can be null

	return makeFormulaNode( CG_DIV, lhs, rhs );;
};

/***************************************************************************
 * emit Division Operation
  ***************************************************************************/	
CCgNodeData* CCilCodeGen::emitDivisionOperator( CCgNodeData* nodetree )
{
